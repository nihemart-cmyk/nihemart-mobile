    ...
    >
      <SafeAreaView className="flex-1 bg-background">
        ...
        <View className="flex-row items-center p-4 border-b border-gray-200">
          ...
          <TouchableOpacity onPress={onClose} className="pl-4">
        ...
        <View className="flex-1 px-4">
          {isLoading || isFetching ? (
            ...
            <View className="flex-1 justify-center items-center">
              <Text className="text-textSecondary text-lg">No results found for "{debouncedSearchQuery}"</Text>
            </View>
          ) : (
            <FlatList
              data={products}
              ...
              renderItem={({ item }) => (
                ...
                >
                  {/* Left Side: Image */}
                  <Image
                    source={{ uri: item.main_image_url || 'https://via.placeholder.com/150' }}
