...
const HomeScreenHeader = ({ categories, featuredProducts }: { categories: any[], featuredProducts: Product[] }) => {
    ...
    <>
      ...
      <View className="py-5">
        <View className="flex-row justify-between items-center px-4 mb-4">
          <Text className="text-text text-2xl font-bold">{t("categories.title")}</Text>
      ...
      <View className="py-5">
        <View className="flex-row justify-between items-center px-4 mb-4">
          <View className="flex-row items-center gap-2">
            ...
            <Text className="text-text text-2xl font-bold">{t("home.deals")}</Text>
          </View>
        </View>
            ...
            >
              ...
              {product.compare_at_price && product.compare_at_price > product.price && (
                <View className="absolute top-2 right-2 bg-primary px-2 py-1 rounded-lg">
                  <Text className="text-white text-xs font-bold">FRW {product.price}</Text>
                </View>
              )}
              <View className="p-3">
                <Text
      ...
      <View className="pt-5 pb-2">
        <View className="flex-row justify-between items-center px-4 mb-2">
          <Text className="text-text text-2xl font-bold">{t("home.allProducts")}</Text>
...
export default function HomeScreen() {
   ...
   const featuredProducts: Product[] = (featuredData as { pages: { products: Product[] }[] })?.pages.flatMap((page) => page.products) || [];
   ...
   const allProducts: Product[] = (productsData as { pages: { products: Product[] }[] })?.pages.flatMap((page) => page.products) || [];
